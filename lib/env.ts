...
export const ADMIN_USERS_PATH = process.env.NEXT_PUBLIC_ADMIN_USERS_PATH || "/api/v1/admin/users"
export const ADMIN_OVERVIEW_PATH = process.env.NEXT_PUBLIC_ADMIN_OVERVIEW_PATH || "/api/v1/admin/overview"
export const ADMIN_ME_PATH = process.env.NEXT_PUBLIC_ADMIN_ME_PATH || "/api/v1/admin"
